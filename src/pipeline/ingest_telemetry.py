...
Extracts video frames at specified FPS, parses DJI subtitle telemetry (SRT),
...
def extract_frames(
    ...
    """
    Extract frames from a video at target_fps and save them into output_images_dir.
    ...
    while True:
        ...
        if max_frames and len(target_indices) >= max_frames:
            break
        idx += 1
...
def main():
    ...
    parser.add_argument("--max_frames", type=int, default=None,
                        help="Optional cap on maximum number of frames to extract")
